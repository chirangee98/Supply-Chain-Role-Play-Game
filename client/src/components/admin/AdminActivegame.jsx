...
const AdminActivegame = ({ handleAdminActiveGame }) => {
  ...
  return (
    <div>
      <h2 className="text-lg font-medium text-gray-800 mb-4">Active Games</h2>
      {games.length > 0 ? (
                  ...
                  <tr key={game._id} onClick={() => handleSelectGame(game._id)}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button 
                        ...
                        onClick={() => handleAdminActiveGame(game._id, 'admingamedashboard')}
                      >
                        View Details
                      </button>
                    </td>
...
export default AdminActivegame;
