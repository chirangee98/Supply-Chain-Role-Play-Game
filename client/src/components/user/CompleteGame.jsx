...
const CompleteGame = ({ handleUserCompleteGame }) => {
  ...
  const fetchGames = async () => {
    try {
      ...
      // Filter games to include only completed games
  ...
  return (
    <div>
      {games ? (
        <div>
          <h2 className="text-lg font-medium text-gray-800 mb-4">My Completed Games</h2>
                    ...
                    <tr key={game._id} onClick={() => handleSelectGame(game._id)}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button 
                          ...
                          onClick={() => handleUserCompleteGame(game._id, 'gamedata')}
                        >
                          View Details
                        </button>
                      </td>
